...
describe("Application", () => {
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    fireEvent.change(getByTestId(container, "student-name-input"), { target: { value: "Eduardo Cesconetto" } });
    expect(getByTestId(container, "student-name-input")).toHaveValue("Eduardo Cesconetto");
   
    fireEvent.click(getByText(appointment, "Save"));
    expect(queryByText(appointment, "Saving")).toBeInTheDocument();

    await waitForElement(() => getByText(container, "Eduardo Cesconetto"));
